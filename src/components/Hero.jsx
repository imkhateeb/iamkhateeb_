    ...
    <section className='relative w-full h-screen mx-auto'>
      ...
      >
        ...
        <div>
          ...
          <div className='animate-sentence-animation'>
            <p className={`${styles.heroSubText} mt-2 text-white-100`}>I am a <br className='sm:block hidden' /> full-stack web developer <br /> and a competetive programmer</p>
          </div>
        </div>
      </div>
      <ComputersCanvas />
